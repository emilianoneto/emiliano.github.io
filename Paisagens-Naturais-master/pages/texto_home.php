<link rel="stylesheet" href="../css/texto_home.css">
<section class="introducao">
    <header>
        <h1 class="t1">França</h1>
    </header>
    <article>
        <p id="texto1" class="oculto">
        ...
        <button class="toggle-btn" onclick="toggleTexto('texto1', this)">Mostrar Mais</button>
    </article>
    <article>
        <p id="texto2" class="oculto">
        ...
        <button class="toggle-btn" onclick="toggleTexto('texto2', this)">Mostrar Mais</button>
    </article>
    <article>
        <p id="texto3" class="oculto">
        ...
        <button class="toggle-btn" onclick="toggleTexto('texto3', this)">Mostrar Mais</button>
    </article>
</section>
<script src="../scripts/texto_home.js"></script>
